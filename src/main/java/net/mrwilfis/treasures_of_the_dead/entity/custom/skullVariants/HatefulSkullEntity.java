...
public class HatefulSkullEntity extends AbstractSkullEntity implements GeoAnimatable, GeoEntity {
    ...
    public HatefulSkullEntity(EntityType pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    @Override
    public ItemStack getTreasureItem() {
        return new ItemStack(ModItems.HATEFUL_SKULL_ITEM.get());
