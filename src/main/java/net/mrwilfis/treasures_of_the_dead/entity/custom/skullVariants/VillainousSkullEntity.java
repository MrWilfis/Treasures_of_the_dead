...
public class VillainousSkullEntity extends AbstractSkullEntity implements GeoAnimatable, GeoEntity {
    ...
    public VillainousSkullEntity(EntityType pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
    }

    @Override
    public ItemStack getTreasureItem() {
        return new ItemStack(ModItems.VILLAINOUS_SKULL_ITEM.get());
