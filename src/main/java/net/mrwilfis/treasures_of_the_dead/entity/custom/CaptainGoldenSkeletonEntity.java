...
public class CaptainGoldenSkeletonEntity extends GoldenSkeletonEntity implements CaptainSkeletonInterface{
    ...
    protected void dropCustomDeathLoot(DamageSource pSource, int pLooting, boolean pRecentlyHit) {
        ...
        if (getCanDropKeysAndOrders()) {
            ...
            if (randomValue < 0.4f) {
                ...
                stack.getTag().putFloat("DeathX", this.getDeathX());
                stack.getTag().putFloat("DeathZ", this.getDeathZ());
                stack.getTag().putFloat("Difficulty", random.nextInt(1,2+1));
    ...
    public void populateDefaultEquipmentSlots(RandomSource pRandom) {
        ...
        //SPAWN OUTFITS
        if (this.getCaptainGoldenVariant().equals(CaptainGoldenSkeletonVariant.DEFAULT)) {
            this.maybeWearEquipment(EquipmentSlot.HEAD, new ItemStack(Items.AIR), pRandom, 1.0f);
