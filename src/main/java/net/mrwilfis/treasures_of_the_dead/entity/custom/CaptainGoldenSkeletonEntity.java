...
public class CaptainGoldenSkeletonEntity extends GoldenSkeletonEntity implements CaptainSkeletonInterface{
    private static final EntityDataAccessor<Float> DEATH_X = SynchedEntityData.defineId(CaptainGoldenSkeletonEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Float> DEATH_Z = SynchedEntityData.defineId(CaptainGoldenSkeletonEntity.class, EntityDataSerializers.FLOAT);
    private static final EntityDataAccessor<Boolean> CAN_DROP_KEYS_AND_ORDERS = SynchedEntityData.defineId(CaptainGoldenSkeletonEntity.class, EntityDataSerializers.BOOLEAN);

    private static final EntityDataAccessor<Integer> DATA_ID_TYPE_VARIANT =
            SynchedEntityData.defineId(CaptainGoldenSkeletonEntity.class, EntityDataSerializers.INT);
    ...
    public void specialProcedures() {
        CaptainGoldenSkeletonVariant variant = Util.getRandom(CaptainGoldenSkeletonVariant.values(), this.random);
        setVariant(variant);
    ...
    protected void applyFiltersForSpecialVariants() {
        if (this.getCaptainGoldenVariant() == CaptainGoldenSkeletonVariant.DEFAULT) {
            this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(Items.AIR));
            this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(Items.AIR));
            this.maybeWearEquipment(EquipmentSlot.CHEST, new ItemStack(ModItems.BLACK_VEST.get()), this.random, 0.95);
            this.setItemSlot(EquipmentSlot.LEGS, new ItemStack(Items.AIR));
            this.maybeWearEquipment(EquipmentSlot.LEGS, new ItemStack(ModItems.CAPTAIN_PANTS.get()), this.random, 0.95);
        }
    }

    public CaptainGoldenSkeletonVariant getCaptainGoldenVariant() {
        return CaptainGoldenSkeletonVariant.byId(this.getTypeVariant() & 255);
    }
