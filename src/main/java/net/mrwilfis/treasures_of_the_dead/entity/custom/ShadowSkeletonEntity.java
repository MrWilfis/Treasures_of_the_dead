...
public class ShadowSkeletonEntity extends TOTDSkeletonEntity{
    ...
    private PlayState spawning(software.bernie.geckolib.animation.AnimationState<ShadowSkeletonEntity> state) {
    ...
    private PlayState walkAndAttack2(software.bernie.geckolib.animation.AnimationState<ShadowSkeletonEntity> state) {
    ...
    private PlayState idleAndWalk2(software.bernie.geckolib.animation.AnimationState<ShadowSkeletonEntity> state) {
        ItemStack mainHandItem = this.getItemInHand(InteractionHand.MAIN_HAND);
