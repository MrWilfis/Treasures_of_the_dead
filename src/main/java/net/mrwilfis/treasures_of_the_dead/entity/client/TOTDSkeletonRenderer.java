...
public class TOTDSkeletonRenderer extends GeoEntityRenderer<TOTDSkeletonEntity> {
    ...
    public TOTDSkeletonRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new TOTDSkeletonModel());
        this.shadowRadius = 0.5f;

        this.addRenderLayer(new ItemArmorGeoLayer<TOTDSkeletonEntity>(this) {
            @Nullable
        ...
        this.addRenderLayer(new BlockAndItemGeoLayer<TOTDSkeletonEntity>(this) {
            @Nullable
            protected ItemStack getStackForBone(GeoBone bone, TOTDSkeletonEntity animatable) {
                //ItemStack var10000;
                return switch (bone.getName()) {
                    case LEFT_HAND -> animatable.isLeftHanded() ?
                            TOTDSkeletonRenderer.this.mainHandItem : TOTDSkeletonRenderer.this.offhandItem;
                    case RIGHT_HAND -> animatable.isLeftHanded() ?
                            TOTDSkeletonRenderer.this.offhandItem : TOTDSkeletonRenderer.this.mainHandItem;
                    default -> null;
                };
    ...
    public void preRender(PoseStack poseStack, TOTDSkeletonEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
    ...
    @Override
    public void render(TOTDSkeletonEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack,
