...
public class IronDaggerRenderer extends GeoEntityRenderer<IronDaggerEntity> {
    public IronDaggerRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new IronDaggerModel());
    }

    @Override
    public ResourceLocation getTextureLocation(IronDaggerEntity instance) {
        return Treasures_of_the_dead.resource("textures/item/iron_dagger.png");
    }

    @Override
    public void render(IronDaggerEntity entity, float entityYaw, float partialTicks, PoseStack poseStack,
