...
public class CaptainGoldenSkeletonRenderer extends GeoEntityRenderer<CaptainGoldenSkeletonEntity> {
    ...
    public static final Map<CaptainGoldenSkeletonVariant, ResourceLocation> LOCATION_BY_VARIANT_RUSTED =
            Util.make(Maps.newEnumMap(CaptainGoldenSkeletonVariant.class), (p_114874_) -> {
                p_114874_.put(CaptainGoldenSkeletonVariant.DEFAULT,
                        Treasures_of_the_dead.resource("textures/entity/rusted_captain_golden_skeleton1.png"));
                p_114874_.put(CaptainGoldenSkeletonVariant.VAR1,
    ...
    public static final Map<CaptainGoldenSkeletonVariant, ResourceLocation> LOCATION_BY_VARIANT_MODEL =
            Util.make(Maps.newEnumMap(CaptainGoldenSkeletonVariant.class), (p_114874_) -> {
                p_114874_.put(CaptainGoldenSkeletonVariant.DEFAULT,
                        Treasures_of_the_dead.resource("geo/captain_golden_skeleton1.geo.json"));
                p_114874_.put(CaptainGoldenSkeletonVariant.VAR1,
                        Treasures_of_the_dead.resource("geo/golden_skeleton.geo.json"));
                p_114874_.put(CaptainGoldenSkeletonVariant.VAR2,
                        Treasures_of_the_dead.resource("geo/golden_skeleton.geo.json"));
            });
    ...
    public CaptainGoldenSkeletonRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new CaptainGoldenSkeletonModel());
        this.shadowRadius = 0.5f;

        this.addRenderLayer(new ItemArmorGeoLayer<CaptainGoldenSkeletonEntity>(this) {
            @Nullable
        ...
        this.addRenderLayer(new BlockAndItemGeoLayer<CaptainGoldenSkeletonEntity>(this) {
            @Nullable
            protected ItemStack getStackForBone(GeoBone bone, CaptainGoldenSkeletonEntity animatable) {
                //ItemStack var10000;
                return switch (bone.getName()) {
                    case LEFT_HAND -> animatable.isLeftHanded() ?
                            CaptainGoldenSkeletonRenderer.this.mainHandItem : CaptainGoldenSkeletonRenderer.this.offhandItem;
                    case RIGHT_HAND -> animatable.isLeftHanded() ?
                            CaptainGoldenSkeletonRenderer.this.offhandItem : CaptainGoldenSkeletonRenderer.this.mainHandItem;
                    default -> null;
                };
    ...
    public ResourceLocation getTextureLocation(CaptainGoldenSkeletonEntity entity) {
        if (entity.getIsRusted()) {
            return LOCATION_BY_VARIANT_RUSTED.get(entity.getCaptainGoldenVariant());
        } else {
            return LOCATION_BY_VARIANT.get(entity.getCaptainGoldenVariant());
        }
        //return new ResourceLocation(Treasures_of_the_dead.MOD_ID, "textures/entity/totd_skeleton.png");
    }

    public void preRender(PoseStack poseStack, CaptainGoldenSkeletonEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
    ...
    @Override
    public void render(CaptainGoldenSkeletonEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack,
