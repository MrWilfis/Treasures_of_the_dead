...
public class GoldenSkeletonRenderer extends GeoEntityRenderer<GoldenSkeletonEntity> {
    ...
    public void preRender(PoseStack poseStack, GoldenSkeletonEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
