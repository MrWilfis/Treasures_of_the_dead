...
public class GoldenDaggerRenderer extends GeoEntityRenderer<GoldenDaggerEntity> {
    public GoldenDaggerRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new GoldenDaggerModel());
    }

    @Override
    public ResourceLocation getTextureLocation(GoldenDaggerEntity instance) {
        return Treasures_of_the_dead.resource("textures/item/golden_dagger.png");
    }

    @Override
    public void render(GoldenDaggerEntity entity, float entityYaw, float partialTicks, PoseStack poseStack,
