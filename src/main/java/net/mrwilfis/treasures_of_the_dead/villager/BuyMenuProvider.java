...
public class BuyMenuProvider implements MenuProvider {
    private final Villager villager;
    private final String companyId;

    public BuyMenuProvider(Villager villager, String companyId) {
...
//                "." + companyId + "_buy");
    ...
    public AbstractContainerMenu createMenu(int containerId, Inventory inventory, Player player) {
        return TradeMenuFactory.createBuyMenu(companyId, containerId, inventory, villager);
    }
}