...
public class CaptainClothes2ArmorRender extends NewArmorRenderer<CaptainClothes2ArmorItem> {
    public CaptainClothes2ArmorRender() {
        super(new CaptainClothes2ArmorModel());
    }
}
