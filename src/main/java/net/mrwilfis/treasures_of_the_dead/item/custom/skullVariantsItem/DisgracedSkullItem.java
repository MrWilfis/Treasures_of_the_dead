...
public class DisgracedSkullItem extends AbstractSkullItem implements GeoItem {
    ...
    public DisgracedSkullItem(Properties pProperties) {
        super(pProperties);
    ...
    public @NotNull InteractionResult useOn(UseOnContext pContext) {
        ...
        DisgracedSkullEntity skull = new DisgracedSkullEntity(ModEntities.DISGRACED_SKULL.get(), pContext.getLevel());     /* Which Skull will be placed */
