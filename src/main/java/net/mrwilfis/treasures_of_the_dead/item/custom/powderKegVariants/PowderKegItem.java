...
public class PowderKegItem extends AbstractPowderKegItem implements GeoItem {
    ...
    public @NotNull InteractionResult useOn(UseOnContext pContext) {
        ...
        if (stack.get(ModDataComponents.KEG_IS_GOING_TO_BLOW_UP) != null) {
            keg.setIsGoingToBlowUp(stack.get(ModDataComponents.KEG_IS_GOING_TO_BLOW_UP).booleanValue());
        }
        if (stack.get(ModDataComponents.KEG_PREPARE_TO_BLOW_UP) != null) {
            keg.setPrepareToBlowUp(stack.get(ModDataComponents.KEG_PREPARE_TO_BLOW_UP).intValue());
        }
